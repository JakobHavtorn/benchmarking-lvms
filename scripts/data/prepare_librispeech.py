...
assert not os.path.exists(librispeech_data_dir), f"Dataset already exists in data directory {librispeech_data_dir}."
assert not os.path.exists(librispeech_source_dir), f"Dataset already exists in source directory {librispeech_source_dir}."
...
for subset in SUBSETS:
    ...
    print(f"\nDownloading - {subset} to `{librispeech_data_dir}`:")
